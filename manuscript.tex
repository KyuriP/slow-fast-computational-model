...
\begin{figure}[htbp]
  ...
  negative); the true network contains no negative edges, so red edges in the estimated networks
  reflect estimation noise rather than the data-generating structure. Edges below a common plotting
